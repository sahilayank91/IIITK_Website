...
var TITLE_LIST = require(__BASE__ + "config/enums").titles;
var GENDER_LIST = require(__BASE__ + "config/enums").genders;
var ASSIGNABLE_ACCESS_LEVELS = require(__BASE__ + "config/enums").assignable_access_levels;
