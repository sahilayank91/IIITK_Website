...
var winston = require('winston'),
    fs = require('fs'),
    logDir = path.join(__BASE__, config.LOGGER.getLoggerBaseDirectory()),
    infoLog = config.LOGGER.getInfoLogFilename(),
    exceptionLog = config.LOGGER.getExceptionLogFilename(),
